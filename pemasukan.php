    ...
    <!-- Sidebar -->
        <ul class="navbar-nav bg-orange sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Kelompok 10<sup>C</sup></div>
            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $sql = "SELECT SUM(line_total) as total from fact_sales where time_id>215 and time_id<=581";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT SUM(line_total) as total from fact_sales where time_id>581 and time_id<=946";
                                            $query = mysqli_query($mysqli,$sql);
                                                while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['total'],0,".",",");
                                                }
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT SUM(line_total) as total from fact_sales where time_id>946 and time_id<=1127";
                                            $query = mysqli_query($mysqli,$sql);
                                                while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['total'],0,".",",");
                                                }
                    ...
                    <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pendapatan Perbulan Tahun 2012</h6>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pendapatan Perbulan Tahun 2013</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pendapatan Perbulan Tahun 2014</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
 ...
 <script src="vendor/jquery/jquery.min.js"></script>
    ...
    <script>
        ...
        <?php
            ...
            // $bulan = "SELECT CONCAT(MONTHNAME(t.tanggal_lengkap), ' ', YEAR(t.tanggal_lengkap)) bulan FROM fact_sales fs JOIN time t ON fs.time_id=t.time_id GROUP BY t.year ORDER BY t.tanggal_lengkap";
            // $linetotal = "SELECT SUM(fs.line_total) line_total FROM fact_sales fs JOIN time t ON fs.time_id=t.time_id GROUP BY t.year ORDER BY t.tanggal_lengkap";
            $bulan = "SELECT CONCAT(MONTHNAME(t.tanggal_lengkap), ' ', YEAR(t.tanggal_lengkap)) as bulan
                        FROM fact_sales fs 
                        JOIN time t 
                        ...
                        GROUP BY t.month 
                        order by t.month;";
            $linetotal = "SELECT sum(fs.line_total) as line_total
                        FROM fact_sales fs 
                        JOIN time t 
                        ON fs.time_id=t.time_id 
                        where t.year='2012' 
